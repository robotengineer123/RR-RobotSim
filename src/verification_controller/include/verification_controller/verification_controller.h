...
namespace verification_controller {
  ...
  private:
    ...
    std::string file = "/home/mathias/dev/RR-RobotSim/src/verification_controller/src/exp5.csv"; // File containing yaw data to mimic
    std::string file_vac = "/home/mathias/dev/RR-RobotSim/src/verification_controller/src/vac5.csv"; // File containing vacuum data to mimic
    double yaw_desi_angle_ = -1.54;
    double steer_desi_angle_ = 9.0;
